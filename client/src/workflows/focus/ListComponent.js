...
import TaskCreateBox from './TaskCreateComponent';
...
class List extends React.Component {
    ...
    render() {
        ...
        var taskCreateBox = (
            <TaskCreateBox uid={this.props.uid} list={list} tasks={tasks} extra={extra} closeCallback={this.createDialogClosed.bind(this)} ref="createBox" />
        );
